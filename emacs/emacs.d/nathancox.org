...
#+begin_src emacs-lisp
  ...
  (defun nc/file-path-for-teammate ()
    "Returns a valid file name for a given teammate."
    (let ((teammate (completing-read "Team mate: " '("Kyle Modlich" "Gary Miller" "Chris Doggett" "Andrew Bonner" "Joe Nelson" "Greg Park"))))
      (nc/file-path-from-title teammate)))
