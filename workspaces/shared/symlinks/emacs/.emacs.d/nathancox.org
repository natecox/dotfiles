...
#+begin_src emacs-lisp
  (use-package org
    ...
    (org-capture-templates
     (doct '(("Task" :keys "t" :headline "Tasks" :template "* TODO %?\n%u\n%a")
             ("Note" :keys "n" :headline "Notes" :template "* %?\n%U")
             ("TIL" :keys "l" :headline "Today I Learned..." :template "* TIL %?\n%U")
             ("Code Reviews" :keys "r" :children
